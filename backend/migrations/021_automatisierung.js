/**
 * Migration 021: Automatisierungs-Grundlagen
 *
 * Fügt hinzu:
...
async function up(db) {
  console.log('Migration 021: Erstelle Automatisierungs-Tabellen...');
  ...
  console.log('✓ Migration 021 abgeschlossen');
}

async function down(db) {
  console.log('Migration 021: Rückgängig...');
