/**
 * Migration 019: Tablet-Einstellungen
 * 
...
async function up(db) {
  console.log('Migration 019: Erstelle tablet_einstellungen Tabelle...');
...
async function down(db) {
  console.log('Migration 019: Entferne tablet_einstellungen Tabelle...');
