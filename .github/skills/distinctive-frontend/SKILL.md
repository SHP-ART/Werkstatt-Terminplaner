...
description: Use when building landing pages, marketing sites, portfolios, dashboards, or any web UI where aesthetics matter - creates visually distinctive, high-impact frontend interfaces that avoid generic "AI slop" aesthetics (Inter font, purple gradients, flat white backgrounds, no animations). Applies four-vector approach: typography, color/theme, motion, and backgrounds.
---
